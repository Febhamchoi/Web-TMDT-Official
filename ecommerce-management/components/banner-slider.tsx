...
export default function BannerSlider({ banners, autoplayInterval = 4000 }: BannerSliderProps) {
  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-8 py-4">
      <div className="relative w-full h-[500px] sm:h-[600px] md:h-[700px] bg-gray-900 overflow-hidden group rounded-lg shadow-lg">
        ...
        <Image
          ...
          priority
          sizes="(max-width: 640px) calc(100vw - 32px), (max-width: 768px) calc(100vw - 48px), calc(100vw - 64px)"
        />
