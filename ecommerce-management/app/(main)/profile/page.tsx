...
import { User, Mail, Shield, Lock, Eye, EyeOff, ChevronRight, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-10 max-w-5xl">
          ...
          <div className="px-8 pb-7 relative">
            ...
            <div className="flex items-end justify-between -mt-12 mb-5">
              <div className="w-20 h-20 rounded-2xl bg-white border-4 border-white shadow-md flex items-center justify-center">
                <span className="text-2xl font-semibold text-gray-800">{initials}</span>
              </div>
              <Button
                variant="outline"
                size="sm"
        ...
        <Tabs defaultValue="info" className="space-y-6">
          <TabsList className="bg-white border border-gray-100 rounded-xl shadow-sm p-1 h-auto w-full grid grid-cols-2 gap-1">
            <TabsTrigger
              value="info"
          ...
          <TabsContent value="info">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-400 mt-0.5">Xem và cập nhật thông tin của bạn</p>
              </div>
              ...
              <form onSubmit={handleChangePassword} className="space-y-5 max-w-md">
                {[
                  ...
                  },
                  {
                    ...
                    onChange: (v: string) => setPasswords((p) => ({ ...p, newPass: v })),
                  },
                  {
                    id: 'confirm',
