...
export default function AdminProductsPage() {
  ...
  return (
    <div className="flex flex-col">
      <AdminHeader title="Quản lý sản phẩm" description={`${totalRows} sản phẩm`} />
      ...
      <div className="flex-1 space-y-4 p-6">
        ...
        {/* Table */}
        <ProductTable products={products} loading={loading} onDeleted={handleDeleted} />

        {/* Pagination */}
        {totalRows > 0 && (
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-500">
              Hiển thị {Math.min((page - 1) * pageSize + 1, totalRows)}–
              {Math.min(page * pageSize, totalRows)} trong {totalRows} sản phẩm
            </p>
            <Pagination>
              <PaginationContent>
                <PaginationItem>
